...
% The formation rule tells us that for any judgement of the form $\Gamma \vdash A \type$, we have a judgemnt of the form $\Gamma, x : A, y : A \vdash \Id_A(x,y)$.
...
% We ask that $r_A$ is stable under pullback: that is, that $r_A$
